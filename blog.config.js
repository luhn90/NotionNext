...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '373428bb0cb145c996c06db6ce990c6f',
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个产品经理, Hi，我是一个福利群主,Hi，我是一个检索达人,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'AttackingTaurus', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个平平无奇的找资源小能手👨‍💻', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://passer1024.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '网站推荐,图书搜索,网址导航,镜像网站,博客', // 网站关键词 英文逗号隔开
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-QLHTFD538E', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-1335703023573181', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
